...
Ported from ``platforms/greenlake/tools/service_catalog__media.py`` in the upstream repo (generated
...
Upstream service: ``service-catalog``   tag: ``media``   operations: 8
"""
...
@tool(
    ...
    annotations={
        "title": "Delete media for service offer",
        "readOnlyHint": False,
...
@tool(
    ...
    tags={"greenlake", "service_catalog"},
    annotations={
        "title": "Get All media for service offer",
        "readOnlyHint": True,
        "destructiveHint": False,
        "idempotentHint": True,
        "openWorldHint": True,
...
@tool(
    ...
    tags={"greenlake", "service_catalog"},
    annotations={
        "title": "Get Single media for service offer",
        "readOnlyHint": True,
        "destructiveHint": False,
        "idempotentHint": True,
        "openWorldHint": True,
...
@tool(
    ...
    annotations={
        "title": "Partially update media for service offer",
        "readOnlyHint": False,
        "destructiveHint": False,
        "idempotentHint": False,
        "openWorldHint": True,
...
@tool(
    ...
    tags={"greenlake", "greenlake_write", "requires_confirmation", "service_catalog"},
    annotations={
        "title": "Mark file upload status as UPLOADED",
        "readOnlyHint": False,
        "destructiveHint": False,
        "idempotentHint": False,
        "openWorldHint": True,
...
@tool(
    ...
    tags={"greenlake", "greenlake_write", "requires_confirmation", "service_catalog"},
    annotations={
        "title": "Update media for service offer",
        "readOnlyHint": False,
        "destructiveHint": False,
        "idempotentHint": False,
        "openWorldHint": True,
