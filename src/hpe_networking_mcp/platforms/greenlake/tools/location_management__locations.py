"""GreenLake Location Management tools -- ported from upstream nowireless4u/hpe-networking-mcp.

Ported from ``platforms/greenlake/tools/location_management__locations.py`` in the upstream repo (generated
...
Upstream service: ``location-management``   tag: ``locations``   operations: 13
"""
...
@tool(
    ...
    tags={"greenlake", "greenlake_write_delete", "location_management", "requires_confirmation"},
    annotations={
...
@tool(
    ...
    tags={"greenlake", "location_management"},
    annotations={
...
@tool(
    ...
    tags={"greenlake", "location_management"},
    annotations={
        "title": "Retrieve location from latitude and longitude.",
        "readOnlyHint": True,
        "destructiveHint": False,
        "idempotentHint": True,
        "openWorldHint": True,
...
@tool(
    ...
    tags={"greenlake", "location_management"},
    annotations={
        "title": "Retrieve a CSV upload status",
        "readOnlyHint": True,
        "destructiveHint": False,
        "idempotentHint": True,
        "openWorldHint": True,
...
@tool(
    ...
    tags={"greenlake", "location_management"},
    annotations={
        "title": "Locations Management service status",
        "readOnlyHint": True,
        "destructiveHint": False,
        "idempotentHint": True,
        "openWorldHint": True,
...
@tool(
    ...
    tags={"greenlake", "location_management"},
    annotations={
        "title": "Get tags for a workspace",
        "readOnlyHint": True,
        "destructiveHint": False,
        "idempotentHint": True,
        "openWorldHint": True,
...
@tool(
    ...
    tags={"greenlake", "location_management"},
    annotations={
        "title": "Retrieves tags for given a location",
        "readOnlyHint": True,
        "destructiveHint": False,
        "idempotentHint": True,
        "openWorldHint": True,
...
@tool(
    ...
    tags={"greenlake", "greenlake_write", "location_management", "requires_confirmation"},
    annotations={
...
@tool(
    ...
    tags={"greenlake", "greenlake_write", "location_management", "requires_confirmation"},
    annotations={
        "title": "Create locations using CSV file",
        "readOnlyHint": False,
        "destructiveHint": False,
        "idempotentHint": False,
        "openWorldHint": True,
