...
Ported from ``platforms/greenlake/tools/device_management__devices_v2beta1.py`` in the upstream repo (generated
...
Upstream service: ``device-management``   tag: ``devices_v2beta1``   operations: 5
"""
...
@tool(
    ...
    tags={"device_management", "greenlake"},
    annotations={
        "title": "Get all devices grouped by given attribute",
        "readOnlyHint": True,
        "destructiveHint": False,
        "idempotentHint": True,
        "openWorldHint": True,
