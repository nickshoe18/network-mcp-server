"""GreenLake Tags tools -- ported from upstream nowireless4u/hpe-networking-mcp.

Ported from ``platforms/greenlake/tools/tags__tags_v1beta1.py`` in the upstream repo (generated
...
Upstream service: ``tags``   tag: ``tags_v1beta1``   operations: 2
"""
...
@tool(
    name="greenlake_get_tags_v1beta1_tag_resources",
    description="GET /tags/v1beta1/tag-resources\n\ngetTagResourcesV1beta1\n\nGet all the tagged resources for a workspace",
    tags={"greenlake", "tags"},
    annotations={
        "title": "Get all the tagged resources for a workspace",
        "readOnlyHint": True,
...
async def greenlake_get_tags_v1beta1_tag_resources(
    ctx: Context,
    filter: Annotated[
        str | None,
        Field(
    ...
    filter_tags: Annotated[
        ...
        Field(
            default=None,
            description="Filter expressions consisting of simple comparison operations joined by logical operators to be applied on the assigned tags or their values. The comparison operations are case-insensitive. <br> | CLASS       | EXAMPLES                                          | |------------|----------------------------------------------------| | Types       | string                                            | | Operations  | eq, ne                                            | **NOTE:** Logical operators are not supported. <br> The examples are not an exhaustive list of all possible filtering on tags options.",
        ),
    ] = None,
    sort: Annotated[
        str | None,
...
@tool(
    name="greenlake_get_tags_v1beta1_tags",
    description="GET /tags/v1beta1/tags\n\ngetTagsV1beta1\n\nGet tags associated to a workspace",
    tags={"greenlake", "tags"},
    annotations={
        "title": "Get tags associated to a workspace",
        "readOnlyHint": True,
        "destructiveHint": False,
        "idempotentHint": True,
        "openWorldHint": True,
...
async def greenlake_get_tags_v1beta1_tags(
    ctx: Context,
    filter: Annotated[
        str | None,
        Field(
