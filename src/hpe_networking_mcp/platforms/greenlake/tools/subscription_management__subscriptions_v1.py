...
Ported from ``platforms/greenlake/tools/subscription_management__subscriptions_v1.py`` in the upstream repo (generated
...
Upstream service: ``subscription-management``   tag: ``subscriptions_v1``   operations: 5
"""
