...
Ported from ``platforms/greenlake/tools/event__webhooks.py`` in the upstream repo (generated
...
Upstream service: ``event``   tag: ``webhooks``   operations: 13
"""
...
@tool(
    ...
    tags={"event", "greenlake"},
    annotations={
        "title": "Fetch recent webhook deliveries",
        "readOnlyHint": True,
        "destructiveHint": False,
        "idempotentHint": True,
        "openWorldHint": True,
...
@tool(
    ...
    tags={"event", "greenlake", "greenlake_write", "requires_confirmation"},
    annotations={
        "title": "Retry webhook delivery failures",
        "readOnlyHint": False,
        "destructiveHint": False,
        "idempotentHint": False,
        "openWorldHint": True,
...
@tool(
    ...
    tags={"event", "greenlake", "greenlake_write", "requires_confirmation"},
    annotations={
        "title": "Webhook Verification Endpoint",
        "readOnlyHint": False,
        "destructiveHint": False,
        "idempotentHint": False,
        "openWorldHint": True,
