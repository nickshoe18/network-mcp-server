...
Ported from ``platforms/greenlake/tools/service_catalog__unredacted_service_offer_regions.py`` in the upstream repo (generated
...
Upstream service: ``service-catalog``   tag: ``unredacted_service_offer_regions``   operations: 2
"""
...
@tool(
    ...
    annotations={
        "title": "Get Unredacted Service Offer Regions",
        "readOnlyHint": True,
...
@tool(
    ...
    tags={"greenlake", "service_catalog"},
    annotations={
        "title": "Get Unredacted Service Offer Region",
        "readOnlyHint": True,
        "destructiveHint": False,
        "idempotentHint": True,
        "openWorldHint": True,
