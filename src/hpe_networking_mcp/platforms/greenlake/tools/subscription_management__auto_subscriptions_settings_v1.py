...
Ported from ``platforms/greenlake/tools/subscription_management__auto_subscriptions_settings_v1.py`` in the upstream repo (generated
...
Upstream service: ``subscription-management``   tag: ``auto_subscriptions_settings_v1``   operations: 3
"""
