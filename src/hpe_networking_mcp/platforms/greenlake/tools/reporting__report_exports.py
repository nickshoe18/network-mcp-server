...
Ported from ``platforms/greenlake/tools/reporting__report_exports.py`` in the upstream repo (generated
...
Upstream service: ``reporting``   tag: ``report_exports``   operations: 2
"""
...
@tool(
    ...
    tags={"greenlake", "greenlake_write", "reporting", "requires_confirmation"},
    annotations={
