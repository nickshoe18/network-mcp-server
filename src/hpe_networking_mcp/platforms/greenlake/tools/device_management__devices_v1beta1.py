...
Ported from ``platforms/greenlake/tools/device_management__devices_v1beta1.py`` in the upstream repo (generated
...
Upstream service: ``device-management``   tag: ``devices_v1beta1``   operations: 5
"""
