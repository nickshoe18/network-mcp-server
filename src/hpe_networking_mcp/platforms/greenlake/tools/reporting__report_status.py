...
Ported from ``platforms/greenlake/tools/reporting__report_status.py`` in the upstream repo (generated
...
Upstream service: ``reporting``   tag: ``report_status``   operations: 2
"""
...
@tool(
    ...
    annotations={
        "title": "Get statuses of all the reports belonging to a workspace",
        "readOnlyHint": True,
